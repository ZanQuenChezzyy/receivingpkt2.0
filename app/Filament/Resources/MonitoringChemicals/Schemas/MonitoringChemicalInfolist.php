        ...
        return $schema
            ->components([
                Section::make('Informasi Dokumen')->schema([
                    ...
                    TextEntry::make('received_date')->date()->placeholder('-'),
                ...
                Section::make('Detail Item Kedatangan')->schema([
                    RepeatableEntry::make('monitoringChemicalDetails')
                        ->schema([
                            ...
                            TextEntry::make('tanggal_pengajuan_simala')->date()->placeholder('-'),
                            TextEntry::make('tanggal_pengambilan_sample')->date()->placeholder('-'),
                            TextEntry::make('tanggal_terbit_coa')->date()->placeholder('-'),
